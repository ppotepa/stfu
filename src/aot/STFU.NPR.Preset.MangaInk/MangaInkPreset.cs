...
namespace STFU.NPR.Preset.MangaInk;
    ...
    public StyleGrammar CreateGrammar()
    {
        ...
        return grammar with
        {
            ...
            [
                ...
                new StyleStrokeProfile(NprStrokeIntent.Boundary, 2.0f, 0.95f, new StrokeColor(0, 0, 0), MediumOverride: StrokeMedium.Marker, HumanizationScale: 0.1f),
