...
namespace STFU.NPR.Preset.PencilConstruction;
...
public sealed class PencilConstructionPreset : INprPreset
{
    ...
    public INprPipeline CreatePipeline() => SketchNprPreset.CreatePipeline();
    ...
    public StyleGrammar CreateGrammar()
    {
        ...
        return grammar with
        {
            ...
            [
                ...
                new StyleStrokeProfile(NprStrokeIntent.Boundary, 1.35f, 0.62f, new StrokeColor(48, 45, 42), MediumOverride: StrokeMedium.Pencil, HumanizationScale: 1.0f),
